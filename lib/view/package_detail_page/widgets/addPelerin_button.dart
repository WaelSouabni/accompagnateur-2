import 'package:accompagnateur/view/addPelerin_page/addPelerin_page_view.dart';
import 'package:flutter/material.dart';
import '../../home_page/components/colors.dart';
import '../../home_page/components/size_config.dart';

class AddPelerinButton extends StatelessWidget {
  const AddPelerinButton({Key? key}) : super(key: key);
    ...
    return Padding(
      ...
      child: Container(
        ...
        child: ElevatedButton(
          ...
          onPressed: () {        Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddPelerinPageView()));
 },
          child: Wrap(
            children: [
              Padding(
