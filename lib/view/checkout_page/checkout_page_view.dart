...
import 'package:accompagnateur/view/bottom_navigator.dart';
...
isCompleted
  ...
  void ajouterAccompgnateur() async {
 ...
 final response = await http.post(
    ...
    if (datauser["success"]) {
      ...
      sharedPreferences.setString("userMail", userdata.email);
         ...
         final response = await http.post(
      Uri.parse(sharedPreferences.getString("url")!+'/Mobile/AccompagnateurStore'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(<String, dynamic>{
        ...
        'telephoneEtranger': sharedPreferences.getString("phoneEtran")!,
